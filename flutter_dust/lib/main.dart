...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: StreamBuilder<AirVisualModel>(
          stream: airBloc.airVisualModel$,
  ...
  Widget _buildContent(AirVisualModel? _result) {
    return Padding(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('습도 ${_result?.data?.current?.weather?.hu ?? 0}%'),
                        Text(
  ...
  Color _getColor(AirVisualModel? _result) {
  ...
  String _getString(AirVisualModel? _result) {
    if (_result?.data?.current?.pollution?.aqius != null) {
      int temp = _result!.data!.current!.pollution!.aqius!;
